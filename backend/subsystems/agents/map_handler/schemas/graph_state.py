...
class MapGraphState(BaseModel):
    ...
    map_executor_applied_operations_log: Annotated[Sequence[ToolLog], log_reducer] = Field(default_factory=list, description="A chronological log of all tool-based operations applied to the simulated map, by the executor agent including 'tool_called', 'success', 'message'.")
    ...
    map_validator_applied_operations_log: Annotated[Sequence[ToolLog], log_reducer] = Field(default_factory=list, description="A chronological log of all tool-based operations applied to the simulated map, by the validator agent including 'tool_called', 'success', 'message'.")
