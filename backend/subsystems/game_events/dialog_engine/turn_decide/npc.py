...
from subsystems.game_events.dialog_engine.prompts.context import get_formatted_human_prompt
...
def decide_next_speaker(event: NPCConversationEvent, event_triggered_by: Optional[ActivationCondition],  game_state: SimulatedGameState) -> Optional[NPCCharacter]:
    """
    ...
    prompt = get_formatted_human_prompt(event_title, event_description, source_beat, current_scenario, characters, relations, game_objective_str, refined_prompt_str, messages)
