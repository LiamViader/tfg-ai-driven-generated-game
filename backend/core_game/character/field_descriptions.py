...
PHYSICAL_ATTRIBUTES_MODEL_FIELDS = {
    "appearance": "A detailed description of the character's physical appearance. Aprox 150 words. The description must be visually concrete and self-contained, explicitly stating all physical traits, Detailed enough for someone to draw it unequivocally.",
