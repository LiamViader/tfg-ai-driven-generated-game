...
if __name__ == '__main__':
    state = MapGraphState(
        ...
        current_objective="Create a map of 5 scenarios for the narrative context DO NOT CREATE MORE THAN 5 SCENARIOS. There shoould only be 1 cluster when finalized. ",
