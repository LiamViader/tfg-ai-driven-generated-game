...
from simulated.versioning.deltas.detectors.field_detector import FieldChangeDetector
from simulated.versioning.deltas.detectors.changeset.map.attributes import ScenarioConnectionsDetector
