...
from simulated.versioning.deltas.detectors.changeset.map.collection import MapDetector
from simulated.versioning.deltas.detectors.changeset.characters.collection import CharactersDetector
